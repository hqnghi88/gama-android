...
├── JarModelInjector.java          build helper that injects the Android sensor GAML
│                                  models into assets/gama.library.jar
...
2. The Gradle task `app:patchGamaJars`:
   ...
   - compiles and runs `JarModelInjector.java` to inject the sensor models.
